...
export const STATUS_MAP = {
  Present:                 { label: "P",               color: "#D7FDF0", type: "Present",textColor: "#ffff" },
  ...
  "Absent(O)":             { label: "A",               color: "#FBA39D", type: "Absent"  },
  ...
  "Today":                 {                           color: "#FFFADF", type: "Present"       },
  "Present:Holiday":       { label: "P/H",             color: "#0ea5e9", type: "Present/Holiday" },
...
export const transformAttendanceData = (data = []) => {
  ...
  // All biometric swipes
  swipes:       Array.isArray(details.swipes) ? details.swipes : [],
